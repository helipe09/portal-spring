...
public enum TipoMovimentoArquivoEnum {
	...
	private TipoMovimentoArquivoEnum(Integer id, String nome) {
		this.id = id;
		this.nome = nome;
	}
	...
	public static TipoMovimentoArquivoEnum recupera(Integer id) {
		...
		if(id == DOWNLOAD.getId()) return DOWNLOAD;
		return null;
	}
}
